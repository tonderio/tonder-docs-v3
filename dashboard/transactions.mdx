...
'og:description': "Manage and track all your payments and transactions in Tonder's secure and reliable database. View comprehensive payment overviews, use efficient filtering, and export transaction data easily."
---
...
<Frame>![](/images/1350x800/dashboard/transactions/transactions.png)</Frame>
...
<Note>
Transaction synchronization that goes through 3DS can take a few minutes to change from `Pending` to `Success` status in the dashboard, but this does not affect the end user.
</Note>
