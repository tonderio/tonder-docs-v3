...
<Card title="Sandbox Mode" icon="flask" href="#stage-mode-stage-tonder-io"/>
...
## [Stage Mode (stage.tonder.io)](https://stage.tonder.io/)

Tonder's Stage Mode, also known as Test Mode, provides a secure environment for developers to test their integration with Tonder. Here are the key features of Tonder's sandbox:

- **True Stage Integration:** Tonder seamlessly integrates with the sandboxes of configured processors, ensuring a comprehensive testing environment.
