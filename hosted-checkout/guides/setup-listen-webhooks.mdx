...
* Review the [Webhook Events & Payloads](https://www.google.com/search?q=/hosted-checkout/reference/webhook-events) reference for a full list of all webhook events and their JSON payloads.
* Learn how to [manually check payment status](https://www.google.com/search?q=/hosted-checkout/guides/manually-check-payment-status) as a fallback if you don't use webhooks.