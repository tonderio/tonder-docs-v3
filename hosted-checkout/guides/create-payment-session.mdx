...
See the [API Reference](https://www.google.com/search?q=/hosted-checkout/reference/api-reference%23post-checkoutv1sessions) for a full list of all available fields.
