...
You can override any default setting for a single payment by passing a ui_config object when you [create a payment session](/hosted-checkout/guides/create-payment-session).
