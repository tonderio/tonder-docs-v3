...
<Card title="Lite SDK Overview" icon="code" href="/integration/sdks/lite-sdk-overview">
  Explore all Lite SDK options including Web, Flutter, Ionic, and React Native implementations.
</Card>
...
<Card title="Full SDK Overview" icon="window" href="/integration/sdks/full-sdk-overview">
  Explore all Full SDK options including Web, Flutter, Ionic, and React Native implementations.
</Card>
