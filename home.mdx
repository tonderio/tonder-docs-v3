...
sidebarTitle: "Home"
'og:description': "Tonder is an all-in-one infrastructure that streamlines payment processing, supports various payment methods, and offers customizable integrations to enhance payment success, prevent fraud, and optimize customer experience."
---
...
<CardGroup>
  ...
  <Card title="Core Concepts" iconType="solid" icon="heart-pulse">
    Learn more about Tonder's core concepts.

    • <u>[Payment Lifecycle](/core-concepts/payment-lifecycle)</u>

    • <u>[3DS Payment Lifecycle](/core-concepts/3ds-lifecycle)</u>

    • <u>[Environments](/core-concepts/Environments)</u>
  </Card>
  ...
  <Card title="Revenue Optimization" iconType="solid" icon="sitemap" href="/revenue-optimization/overview">
  ...
  <Card title="Integrate Tonder" icon="window" href="/integration/intro">
    Integrate Tonder into your applications using SDKs.
  </Card>
