...
Create an instance of the `InlineCheckout` class to establish a secure connection with Tonder's payment services. This initialisation configures the SDK with your API credentials and sets up the operating mode for your environment.
