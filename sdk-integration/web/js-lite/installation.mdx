---
title: "Installation (JS Lite)"
description: "How to install and set up Tonder's JS Lite SDK in your web project."
---

This guide provides the installation steps for Tonder's JavaScript Lite SDK.
