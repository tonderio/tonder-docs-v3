...
These recommendations will help you create a smooth SPEI payment experience for your customers:

- Make bank transfer steps obvious to customers.
- Set up [webhooks](/direct-integration/webhooks/how-webhooks-works) instead of relying on polling for status updates.
