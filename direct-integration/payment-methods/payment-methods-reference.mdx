...
All payment methods share these common parameters:
...
Here you can find the status flow reference for each payment method:
...
Here you can find the error codes reference for each payment method:
