...
|-------|------|-------------|
| `account` | string | The CLABE number identifying the recipient's bank account. |
...
| `institution` | string | Bank code corresponding to the first 3 digits of the CLABE (with "40" prefix). |

## See also

You can find more information about the Mexican banking system in the following guides:

- Refer to [CLABE Validation](/direct-integration/reference/clabe-validation) to validate and parse CLABE numbers.
