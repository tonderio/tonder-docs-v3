...
<CardGroup cols={4}>
  <Card icon="building-columns" iconColor="#3B82F6">
    <span style={{color: '#3B82F6', fontSize: '1.0rem', fontWeight: 'bold'}}>012</span>
    
    
    **Bank Code**
    
    3 digits (positions 1-3)
    
    Identifies the financial institution. See [Institution Codes](/direct-integration/reference/institution-codes).
  </Card>
  <Card icon="code-branch" iconColor="#10B981">
    <span style={{color: '#10B981', fontSize: '1.0rem', fontWeight: 'bold'}}>345</span>
    
    **Branch Code**
    
    3 digits (positions 4-6)
    
    Identifies the specific branch or plaza.
  </Card>
  <Card icon="hashtag" iconColor="#F59E0B">
    <span style={{color: '#F59E0B', fontSize: '1.0rem', fontWeight: 'bold'}}>67890123456</span>
    
    **Account Number**
    
    11 digits (positions 7-17)
    
    Unique account identifier within the branch.
  </Card>
  <Card icon="circle-check" iconColor="#8B5CF6">
    <span style={{color: '#8B5CF6', fontSize: '1.0rem', fontWeight: 'bold'}}>7</span>
    
    **Check Digit**
    
    1 digit (position 18)
    
    Validates the entire CLABE using a weighted algorithm.
  </Card>
</CardGroup>
