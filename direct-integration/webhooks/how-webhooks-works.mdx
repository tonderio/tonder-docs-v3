...
<CardGroup cols={3}>
  ...
  <Card title="Delivery & Retry" icon="refresh" href="/direct-integration/webhooks/delivery-and-retry">
...
- [Create a Payment](/direct-integration/guides/create-payments/create-a-payment) - Learn about events that trigger webhooks
- [HTTP Response Codes](/direct-integration/http-response-codes) - Proper status codes for webhook responses
- [Testing Data](/direct-integration/testing-data) - Sample data for testing webhook implementations
