...
For payments, you can accept money from your customers using various methods. Whether they want to pay with a [credit or debit card](/direct-integration/payment-methods/card-payments), make a [bank transfer through SPEI](/direct-integration/payment-methods/spei-bank-transfers), or pay cash at [OXXO convenience stores](/direct-integration/payment-methods/oxxo-cash-payments), the same endpoint handles it all.
