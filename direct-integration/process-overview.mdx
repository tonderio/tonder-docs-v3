...
Once all checks are complete and your Tonder CSM has activated your production access, you can switch to the production base URL (`https://app.tonder.io/api/v1/`) and use your production API keys. At this point, you are ready to process real payments and withdrawals.
</Step>
</Steps>
...
- Start with the [quickstart guide](/direct-integration/quickstart) to make your first transaction
- Review [authentication methods](/direct-integration/authentication) to secure your integration
- Set up [testing environments](/direct-integration/environment) before going live
- Implement [webhook notifications](/direct-integration/webhooks/how-webhooks-works) for real-time updates
