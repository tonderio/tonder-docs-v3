...
- [Create a basic payment](/direct-integration/guides/create-payments/create-a-payment) - Start with simple card payments.
- [Create a payment with 3DS](/direct-integration/guides/create-payments/create-a-payment-with-3ds) - Test 3D Secure authentication.
- [Create a payment with card tokens](/direct-integration/guides/create-payments/create-a-payment-with-a-card-token) - Use tokenized card data.
- [Create a multi-method payment](/direct-integration/guides/create-payments/create-a-multi-method-payment) - Implement fallback payment options.
- [Raw card processing](/direct-integration/guides/create-payments/raw-card-processing) - Direct card processing without tokenization.
</Step>
