...
```json Initial Request
{
  ...
  "payment_method": {
    "type": "CARD",
    "card_number": "4456528080389860" // Test card that triggers 3DS
  },
...
- Try [creating payments with card tokens](/direct-integration/guides/create-payments/create-a-payment-with-a-card-token) to securely store and reuse customer payment methods.
