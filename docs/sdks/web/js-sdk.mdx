...
The first tag is mandatory for achieving PCI DSS (Payment Card Industry Data Security Standard), as stated at the top of this page, by using Skyflows's integration. The other tags are needed to integrate with OpenPay to use them as a payment processor.
