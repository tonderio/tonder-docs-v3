...
When [initializing the SDK instance](./js-sdk#configuration), you are required to send your styles as part of the payload. This page presents you with detailed information about each available customization.
