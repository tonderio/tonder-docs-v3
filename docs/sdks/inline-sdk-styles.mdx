...
When [initializing the SDK instance](./inline-sdk#usage), you are required to send your styles as part of the payload. This page presents you with detailed information about each available customization.
...
Here is an example of the `inputStyles` customizations:
```javascript
  const customStyles = {
    inputStyles: {
      base: {
