...
When [initializing the SDK instance](./inline-sdk#configuration), you are required to send your styles as part of the payload. This page presents you with detailed information about each available customization.
  ...
  ```javascript
    const customStyles = {
      ...
      labels: {
        ...
        expiryMonthLabel: 'Expiring month',
        expiryYearLabel: 'Expiring year'
      },
      ...
    }
  ```
