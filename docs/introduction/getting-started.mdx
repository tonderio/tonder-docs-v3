...
<Steps>
  <Step title="Set up your account">
    You can start creating your Tonder account by accessing https://stage.tonder.io/users/create-user-business/, and following these steps:

    1. Enter the needed information.
    2. Verify your email address.
    3. Add your business's information.

    Below you will find the account creation process:
    <Frame>![](/images/introduction/account-creation-gif.gif) </Frame>
  ...
  <Step title="Create a payment link">
    ...
    <Frame>![](/images/introduction/payment-link-creation-gif.gif) </Frame>
  ...
  <Step title="Process your first payment">    
    ...
    <Frame>![](/images/introduction/payment-link-payment-gif.gif) </Frame>
  </Step>
  ...
  <Step title="Validate the payment">
    ...
    <Tabs>
      <Tab title="Transactions">
        <Frame>![](/images/introduction/payment-confirmed.png) </Frame>
      </Tab>
      <Tab title="Transaction details">
        <Frame>![](/images/introduction/payment-confirmed-details.png) </Frame>
      </Tab>
    </Tabs>
  </Step>
</Steps>
