...
<Note>
 #### Creation of your sandbox account
...
1. **Adding your first connections**: To integrate Tonder with payment providers, go to the Connections section. Select the payment providers you want to connect with and enter your payment provider Sandbox (test) API keys. Once done, click on the "Connect" button. Finally, check the "Your Connections" section to confirm that the PSPs have been successfully connected.
...
| :-----------------------------------------: | :--------------: | :--------: | :--------------: | :-------------: |
|    Stripe<br></br>Openpay<br></br>Conekta   | 4242424242424242 |  Any name  | Any three digits | Any future date |
