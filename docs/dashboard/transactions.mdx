...
<Frame>![](/images/dashboard/dashboard-transactions-overview.png)</Frame>
...
You can access details for each payment by clicking on the arrow at the end of each payment row. To find which details you find in this page, refer to the [Transaction detail page](./transaction-details) of the guides.