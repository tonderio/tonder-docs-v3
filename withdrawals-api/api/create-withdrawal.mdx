...
**Every single request** to this endpoint requires authentication. The `Authorization` header must be included in:
...
Replace `<YOUR_API_KEY>` with the token provided in the **Developers section** of the Tonder platform. See [Authentication requirements](/withdrawals-api/integration-security) for detailed instructions.
</Warning>
