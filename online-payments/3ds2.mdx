...
<CardGroup cols={1}>
  <Card title="Advanced Risk-Based Authentication">
    Issuers can assess the risk level of each transaction with higher accuracy by analyzing a wealth of transaction data in real-time. As a result, they can better differentiate between low-risk and high-risk transactions and apply stringent authentication only when necessary. 
  </Card>
  <Card title="Reduced Fraud Rates">
    As a result of more secure transactions, merchants and issuers can see a reduction in fraudulent activities and associated costs.
  </Card>
  <Card title="Alignment with Global Standards">
    The checkout satisfies global security standards for online transactions, enabling merchants and issuers to comply with regulations.
  </Card>
</CardGroup>
